...
"""
    ...
    1. Starting point
        ...
        Path operations would expect JSON body with the attribute of an Item, like
        {
            "name": "Foo",
    ...
    2. Multiple body parameters
        Dude i love fastapi design, this is epic, when dealing multiple body parameter,
        just declare it, and add it on function api..
        The code:
            from fastapi import FastAPI
            from typing import Optional
            from pydantic import BaseModel
